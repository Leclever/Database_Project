    ...
    public static void main(String[] args) throws Exception {
        ...
        do {
            ...
            // User login
                ...
                PreparedStatement userLogin = conn.prepareStatement("SELECT * FROM Customer WHERE customer_name = ? AND password = ?");
                String pwd;
                do {
                    System.out.print("Enter your username: ");
                    name = scanner.nextLine();
        ...
        while (!quit) {
            ...
            System.out.println("2.Searching product\n3.Shopping Chart\n4. Inventory Management (Administrators Only)\n5. Analysis Report (Administrators Only) ");
...
//                                int new_stock_level = 0;
                                ...
                                while (rs.next()) {
                                    ...
                                    insert_order.setFloat(6, overallPrice);
